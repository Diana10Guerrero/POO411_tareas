...
void Sistema::agregar(const Estudiante& e)
{
    listaEstudiantes.push_back(e);
}

void Sistema::agregar(const Profesor& p)
{
    listaProfesores.push_back(p);
}

void Sistema::agregar(const Materia& m)
{
    listaMaterias.push_back(m);
}

void Sistema::agregar(const Calificacion& c)
{
    listaCalificaciones.push_back(c);
}
